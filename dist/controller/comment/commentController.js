...
exports.RetriveCommentController = exports.RetriveCommentsController = exports.CreateCommentController = void 0;
...
const RetriveCommentController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const user = req.user;
    const commentId = (_b = req.params) === null || _b === void 0 ? void 0 : _b.commentId;
    if (!commentId)
