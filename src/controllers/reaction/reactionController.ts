...
//     const transection = await performTransection(async (session) => {
...
//       await mongoClientDb.collection<IPost>(COLLECTIONS.POST).updateOne(
...
//       );
//     });
//     if (transection.success) {
//       res.json({ data: { ...doc } });
//     } else if (transection.cause === UNPROCESSABLE_ENTITY_ERROR) {
